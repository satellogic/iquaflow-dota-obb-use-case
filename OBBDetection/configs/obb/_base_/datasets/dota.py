...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        task='Task1',
        ann_file=data_root + 'train#quant6_modifier/annfiles',
        img_prefix=data_root + 'train#quant6_modifier/images',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        task='Task1',
        ann_file=data_root + 'val#quant6_modifier/annfiles',
        img_prefix=data_root + 'val#quant6_modifier/images',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        task='Task1',
        ann_file=data_root + 'test#quant6_modifier/annfiles',
        img_prefix=data_root + 'test#quant6_modifier/images',
        pipeline=test_pipeline))
