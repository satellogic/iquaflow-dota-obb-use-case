...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        task='Task1',
        ann_file=data_root + '__TRAIN_ANNFILES__',
        img_prefix=data_root + '__TRAIN_IMAGES__',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        task='Task1',
        ann_file=data_root + '__VAL_ANNFILES__',
        img_prefix=data_root + '__VAL_IMAGES__',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        task='Task1',
        ann_file=data_root + '__TEST_ANNFILES__',
        img_prefix=data_root + '__TEST_IMAGES__',
        pipeline=test_pipeline))
