...
# Note: /data is $(DS_VOLUME) within docker
# # Symlinks
rm -rf data && \
...
ln -sf /data/DOTA1_0/train $(pwd)/data/DOTA1_0/train && \
ln -sf /data/share/pgalles/data/HRSC2016 $(pwd)/data

# Split val to val/test through symlinks
export VALDIR=/data/DOTA1_0/val && python -c "
import os
import sys
import random
import glob
